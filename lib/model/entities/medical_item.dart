...
@JsonSerializable()
class MedicalItem extends InventoryItem{
  ...
  factory MedicalItem.fromJson(Map<String, dynamic> json) => _$MedicalItemFromJson(json);

  Map<String, dynamic> toJson() => _$MedicalItemToJson(this);
